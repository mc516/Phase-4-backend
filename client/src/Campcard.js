...
function CampCard({camp, image, addComment, user, comments, removeComment}) {
    return (  
        <div className="camps-card" >   
            ...
            {<Comments  addComment={addComment} user={user} camp={camp} comments={comments} removeComment={removeComment}/>}
        </div>
    )
}
